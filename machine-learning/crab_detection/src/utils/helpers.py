...
MULTI_CLASS_MAP = {0: "Jonah Crab", 1: "Green Crab", 2: "Rock Crab"}

# Binary mapping (Green vs Not Green)
BINARY_CLASS_MAP = {0: "Green Crab", 1: "Not Green Crab"}
...
def count_green_crabs(detections, mode="multi"):
    ...
    count = 0
    target_id = (
        1 if mode == "multi" else 0
    )  # In binary, Green is usually 0 (positive class)
